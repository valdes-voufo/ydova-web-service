...
import com.ydova.cv.dto.LanguageLevel;
import com.ydova.cv.dto.TimeLineEntryDto;
...
public class CVGenerator {
    ...
    public File generateCV(CVDto dto) throws CVGenerationException {
        ...
        File pdfFile = new File("ExamplePdf");
    ...
    public void mkRightSection(PdfCanvas canvas, Document document, CVDto dto) {
        ...
        //ausbildung +line
        int expCount = dto.getExperience().size();
    ...
    private  void addTimeLine(Document document, PdfCanvas canvas, List<TimeLineEntryDto> timeLineEntries, float y) {
        ...
        for (int i = 0; i < timeLineEntries.size(); i++) {
            ...
            leftCell.add(new Paragraph(entry.getSchool()).setFontSize(10));
    ...
    public  Cell mkLeftSection(PdfCanvas canvas, Document document, CVDto dto) throws CVGenerationException {
        ...
        IBlockElement birthCountry = mkInfoWithoutIcon(birthdayCountryLabel, dto.getBirthCountry());
